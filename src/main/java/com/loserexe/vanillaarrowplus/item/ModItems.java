...
public class ModItems {
    ...
    public static final Item AERIAL_ARROW = register("aerial_arrow", new ModdedArrowItem<>(AerialArrowEntity::new));
    ...
    public static final Item PRISMARINE_ARROW = register("prismarine_arrow", new ModdedArrowItem<>(PrismarineArrowEntity::new));
    ...
    public static final Item SLIME_ARROW = register("slime_arrow", new ModdedArrowItem<>(SlimeArrowEntity::new));
